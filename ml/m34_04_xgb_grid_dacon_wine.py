...
x_train,x_test,y_train,y_test = train_test_split(x,y,random_state=950228,train_size=0.8,stratify=y)
...
splits = 4
kFold = StratifiedKFold(n_splits=splits,shuffle=True,random_state=970828)
...
model = RandomizedSearchCV(xgb, parameters, cv=kFold,n_jobs=-3,random_state=112)
