...
# 디폴트 100 / 1~inf / 정수 - 통상적으로 커야 좋음 / 너무 크면 과적합
# 'learning_rate' : [0.1,0.2,0.3,0.5,1,0.01,0.001] 
# 디폴트 0.3 / 0~1 / eta -*중요* 학습률 - 통상적으로 작으면 디테일하게해서 좋음 / 너무 작으면 오래걸리고 안좋을수도있음
...
# 디폴트 0 / 0~inf / L1 절대값 가중치 규제 / alpha 
# 'reg_lambda' : [0,0.1,0.01,0.001,1,2,10] 
# 디폴트 1 / 0~inf / L2 제곱 가중치 규제 / lambda
...
# 2. model
xgb = XGBRegressor(random_state=111)
