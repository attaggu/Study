...
model = BaggingRegressor(xgb,
                          ...
                          n_jobs=-1,
                          random_state=777,
                          bootstrap=True, #최종 점수 :  0.8419477112539868
                          # bootstrap=False,  #최종 점수 :  0.8265971742562204
...
#                           n_jobs=-1,
#                           random_state=77,
#                           bootstrap=True,     #최종 점수 :  0.47076181397522054
#                           # bootstrap=False,  #0.07446822481411719
#                           #디폴트 , 중복 허용 / False = 중복안허용
#                           )
