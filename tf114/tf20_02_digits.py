...
w1 = tf.compat.v1.Variable(tf.random_normal([64,10], name='weight1')) # (n,10) = (n,2)에 * (2,10)이 곱해져야 나옴
...
w5 = tf.compat.v1.Variable(tf.random_normal([7,10], name='weight5')) # (n,9) 에 (9,8)를 곱해 (n,8)
