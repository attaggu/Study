...
w1 = tf.compat.v1.Variable(tf.random_normal([10,10], name='weight1')) # (n,10) = (n,2)에 * (2,10)이 곱해져야 나옴
...
optimizer = tf.compat.v1.train.AdamOptimizer(learning_rate=0.008)
...
predict = sess.run(hypothesis, feed_dict={xp: x})
