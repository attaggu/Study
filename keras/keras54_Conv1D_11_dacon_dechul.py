...
from keras.layers import Dense, Dropout, Input,LSTM,Flatten,Conv1D
...
model = Sequential()
# model.add(LSTM(13, input_shape=(13,1), activation='swish'))
model.add(Conv1D(10,2,input_shape=(13,1),activation='swish'))
model.add(Flatten())
...
model.fit(x_train, y_train, epochs=99, batch_size = 1500,
...
print("acc : ", results[1])  
print("f1 : ", f1)  
submission_csv.to_csv(path + "submission_0130_5.csv", index=False)
